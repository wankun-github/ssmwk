...
/**
 * Created by wankun on 2017/7/12.
 * 拦截器类
 */
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    private static final String LOGIN_URL = "/common/toHtml?pageName=home/login";
    /**
     * 在业务处理器处理请求之前被调用
     * 如果返回false
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        Object obj =  request.getSession().getAttribute("SESSION_USER_NAME");
        if(obj == null){  //判断用户是否存在，不存在返回登录界面，继续拦截，存在通过拦截，放行到访问页面
            /**
             * 拦截目录下请求，是否为ajax请求
